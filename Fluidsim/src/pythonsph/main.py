...
import hidgamepad.asynchronous_example as gamepad# Setting up the accelerometer connection (replace with your specific port)
...
# Start threads
accel_thread = threading.Thread(target=gamepad.read_gamepad_data, daemon=True)
